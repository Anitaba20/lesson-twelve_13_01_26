...
class TouristCity(City):
    ...
    def income(self):
        return super().income() + self.number_of_visitors * 5
...
kosice = CulturalCity("Kosice", "Kosice", "Slovensko", 100000, 1000, 1000, 100)
mikulas = TouristCity("Liptovsky Mikulas", "Zilinsky", "Slovensko", 100000, 1000, 1000, 10000)
zlin = IndustrialCity("Zlin", "Zlinsky", "Cesko", 12231, 1232, 1222, 2)
